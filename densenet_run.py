...
if os.path.isdir('densenet') == True:
    shutil.rmtree("densenet")
...
def main(gpu, args):
    ...
    SAVE_DIR = 'models'
    MODEL_SAVE_PATH = os.path.join(SAVE_DIR, 'densenet_lrhr_v1.pt')
    ...
    for epoch in range(args.n_epochs):
        ...
        for iter, (data, labels) in enumerate(train_loader):
            ...
            if step % args.eval_every == 0:
                ...
                with open('densenet/training.txt', 'a') as training:
                ...
                with open('densenet/time.txt', 'a') as training:
